...
@implementation GTOpDeleteRemote

- (id) initWithGD:(GittyDocument *)_gd andRemoteName:(NSString *) _remoteName {
...
- (void) setArguments {
	...
	[self setArgumentsWithPythonScript:[GTPythonScripts deleteRemote] setArgsOnTask:false];
