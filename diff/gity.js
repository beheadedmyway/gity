...
function addAuthor()
{
	if(commitDetails.authorEmail) commitDetailsTableContent.push("<tr><td class='detailItemLabel'>Author:</td><td class='detailItem'>"+commitDetails.author+" &lt;<a href='mailto:"+commitDetails.authorEmail+"'>"+commitDetails.authorEmail+"</a>&gt;</td></tr>");
	else commitDetailsTableContent.push("<tr><td class='detailItemLabel'>Author:</td><td class='detailItem'>"+commitDetails.author+"</td></tr>");
}
